...
export class GalleryComponent implements OnInit {
  ...
  public getProduct():void{
    this._productService.getById(this.productID, this.token).subscribe((response) => {
  ...
  public upload():void{
    ...
    this._productService.uploadGalleryImage(this.token, newGalleryImage, this.productID).subscribe((response) => {
  ...
  public onSubmit(pathArray:[]):void{
    this._productService.setGalleryImages(this.token, pathArray, this.productID).subscribe((response) => {
      if(!response.product) return;
  ...
  public removeTempImage(imagePath:string, index:number):void{
    let image = <string>this.tempGalleryImages.find(element => element == imagePath);
